...
function UserMain() {
    ...
    //for test
    const salaryInfo = [{ value: 0, lable: "Полная ЗП", }, { value: 0, lable: "Больничный" }, { value: 0, lable: "Доп.Выплаты" }, { value: 0, lable: "Отпускные" }, { value: 0, lable: "Итог" }, { value: 0, lable: "Отпускные на карту" }, { value: 0, lable: "Аванс наличные" }, { value: 0, lable: "Аванс Карта" }, { value: 0, lable: "ЗП карта" }, { value: 0, lable: "НДФЛ" }, { value: 0, lable: "Прогул" }, { value: 0, lable: "Сбор на ДР" }, { value: 0, lable: "Итог" }];
        ...
        <div className="h-[100vh]  flex justify-center  bg-green-100  max-sm:p-1 " >
            <div className="w-[60vw]  max-[1100px]:w-[99vw]">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <UserShifts className='w-[100%]' shift={shifts} />
                    <Panel >
